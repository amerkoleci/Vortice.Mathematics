...
public readonly struct UShortN4 : IPackedVector<ulong>, IEquatable<UShortN4>
{
    [FieldOffset(0)]
    ...
    public UShortN4(ulong packedValue)
    {
    ...
    public UShortN4(ushort x, ushort y, ushort z, ushort w)
    {
        Unsafe.SkipInit(out this);
    ...
    /// <param name="z">The z value.</param>
    /// <param name="w">The w value.</param>
    public UShortN4(float x, float y, float z, float w)
    {
        Unsafe.SkipInit(out this);
    ...
    public UShortN4(in Vector4 vector)
    ...
    /// <inheritdoc/>
    public override bool Equals(object? obj) => obj is UShortN4 other && Equals(other);

    /// <inheritdoc/>
    public bool Equals(UShortN4 other) => PackedValue.Equals(other.PackedValue);

    /// <summary>
    /// Compares two <see cref="UShortN4"/> objects for equality.
    /// </summary>
    /// <param name="left">The <see cref="UShortN4"/> on the left hand of the operand.</param>
    /// <param name="right">The <see cref="UShortN4"/> on the right hand of the operand.</param>
    /// <returns>
    /// True if the current left is equal to the <paramref name="right"/> parameter; otherwise, false.
    /// </returns>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static bool operator ==(UShortN4 left, UShortN4 right) => left.Equals(right);

    /// <summary>
    /// Compares two <see cref="UShortN4"/> objects for inequality.
    /// </summary>
    /// <param name="left">The <see cref="UShortN4"/> on the left hand of the operand.</param>
    /// <param name="right">The <see cref="UShortN4"/> on the right hand of the operand.</param>
    /// <returns>
