...
public readonly struct NormalizedByte2 : IPackedVector<ushort>, IEquatable<NormalizedByte2>
{
    [FieldOffset(0)]
    ...
    public NormalizedByte2(ushort packedValue)
    {
    ...
    public NormalizedByte2(Vector4 vector)
        : this(vector.X, vector.Y)
    {
    }
    ...
    /// <inheritdoc/>
    public bool Equals(NormalizedByte2 other) => PackedValue.Equals(other.PackedValue);

    /// <summary>
    /// Compares two <see cref="NormalizedByte2"/> objects for equality.
    /// </summary>
    /// <param name="left">The <see cref="NormalizedByte2"/> on the left hand of the operand.</param>
    /// <param name="right">The <see cref="NormalizedByte2"/> on the right hand of the operand.</param>
    /// <returns>
    ...
    /// <summary>
    /// Compares two <see cref="NormalizedByte2"/> objects for inequality.
    /// </summary>
    /// <param name="left">The <see cref="NormalizedByte2"/> on the left hand of the operand.</param>
    /// <param name="right">The <see cref="NormalizedByte2"/> on the right hand of the operand.</param>
    /// <returns>
