...
namespace Vortice.Mathematics
{
    ...
    public struct ViewportF : IEquatable<ViewportF>
    {
        ...
        public ViewportF(float width, float height)
        {
            X = 0.0f;
            Y = 0.0f;
            Width = width;
        ...
        public ViewportF(Vector4 bounds)
        {
            X = bounds.X;
            Y = bounds.Y;
            Width = bounds.Z;
        ...
        /// <inheritdoc/>
		public override bool Equals(object obj) => obj is ViewportF value && Equals(ref value);
        ...
        public bool Equals(ViewportF other) => Equals(ref other);
        ...
        /// <summary>
        /// Compares two <see cref="ViewportF"/> objects for equality.
        /// </summary>
        /// <param name="left">The <see cref="ViewportF"/> on the left hand of the operand.</param>
        /// <param name="right">The <see cref="ViewportF"/> on the right hand of the operand.</param>
        /// <returns>
        /// True if the current left is equal to the <paramref name="right"/> parameter; otherwise, false.
        /// </returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static bool operator ==(ViewportF left, ViewportF right) => left.Equals(ref right);

        /// <summary>
        /// Compares two <see cref="ViewportF"/> objects for inequality.
        /// </summary>
        /// <param name="left">The <see cref="ViewportF"/> on the left hand of the operand.</param>
        /// <param name="right">The <see cref="ViewportF"/> on the right hand of the operand.</param>
        /// <returns>
